# Work section static images

Some project cards on the home page (`index.html`, `#work` section) use a
still photo pair instead of a video clip — same full-width, side-by-side
