...
The first card (fire drone) shows two clips side by side — the
navigation run and the separate fire/thermal simulation.
...
| `motion-planning-turtlebot.mp4`        | Motion Planning & Coordination for Autonomous Vehicles | `rTKAuFA87B4`, 0:15–0:28, 1080p source |
